package com.edlplan.framework.ui.text.font;
...
public enum FontAwesome {
    ...
    public static FontAwesome get(int i) {
        return values()[i];
    }

    public AbstractTexture getTexture() {
        if (texture == null) {
            final BMFont f = BMFont.getFont(BMFont.FontAwesome);
            final FNTChar c = f.getFNTCharSafe(charvalue);
            final GLTexture tex = f.getPage(c.page).texture.getTexture();
            texture = new TextureRegion(tex, RectF.xywh(c.x, c.y, c.width, c.height));
        }
        return texture;
    }
}
